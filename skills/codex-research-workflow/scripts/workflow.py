...
def initialize_authorities(repo: Path) -> List[str]:
    ...
    if not agents.exists():
        agents.write_text(
            ...
            "direction changes.\n"
            "- A Goal authorizes the named work and necessary consequences, not adjacent improvements. "
            "A consequence is necessary only if omitting it would make the current result incorrect, "
            "materially incomplete, non-reproducible, or unable to satisfy stated acceptance; do not "
            "expand for hypothetical future needs.\n"
            "- Discussion, inspection, audit, and review-only Goals are read-only unless they explicitly "
            "authorize a change. Include affected callers, configurations, focused tests, and evidence "
            ...
            "- A decision-complete Codex result packet normally supports the next decision. Optional implementation "
            ...
            "four-section format or output a `Codex 指令`. For decision-relevant evidence, a formal review, "
