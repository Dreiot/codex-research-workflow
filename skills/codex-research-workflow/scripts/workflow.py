...
def initialize_authorities(repo: Path) -> List[str]:
    ...
    if not agents.exists():
        agents.write_text(
            ...
            "for current state. Verify both against Git before governed work.\n"
            ...
            "a major implementation baseline, freezing a publication evaluation, adopting a key result, "
            ...
            "- Browser Work responses must follow the public Work Response Contract. A clean review-state "
            "verification may be followed by the next Goal in the same response.\n"
            "- Work verification of a formal review-state commit is mechanical closure, not a new review.\n"
            ...
            "- Track scripts, configs, registry entries, and evidence packets. Ignore run outputs, "
